    ...
    <div className="pt-24 md:pt-32">
      ...
      <div className="container mx-auto px-6 mb-16 md:mb-24">
        ...
        <div className="rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white h-[400px] md:h-[500px]">
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2483.5!2d-0.1276!3d51.5074!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487604ce3f0df0f5%3A0x0!2sLondon%2C%20UK!5e0!3m2!1sen!2sgb!4v1609459200000!5m2!1sen!2sgb"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen
